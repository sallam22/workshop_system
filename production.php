        ...
        <div  class="wrapper wrapper--w900">
            <div  class="card card-6">
                <div  class="card-heading">
                    <h2   style="background-color: darkcyan;" class="title">Daily production Data of Workshop101</h2>
                </div>
                <div  class="card-body">
                    <form  method="POST" >
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <textarea class="textarea--style-6" name="order_value" placeholder=""></textarea>
